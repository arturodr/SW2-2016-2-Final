...
<html>
    ...
    <body>
        ...
        <div class="row-fluid" style=" width: 80%; padding:0 10%;">
            ...
            <%-- Tabla con los datos --%>             
            <div class="span10">
                <c:if test="${ListaCarrito.size()>0}">
                Se encontraron ${ListaCarrito.size()} videojuegos en el carrito
                </c:if>
                <a href="<spring:url value='/shop/carrito'/>" class="btn btn-primary pull-right"><i class="icon-white icon-shopping-cart"></i>  Carrito de Compras</a><br><br>
                <div class="well form-horizontal-search">
                    
                    <form:form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/shop/search" modelAttribute="juego">
                    ...
                    <tbody>
                        <c:forEach var="juego" items="${ListaJuegos}">  
                            <tr>
                                ...
                                <td class="span3"><a href="${pageContext.request.contextPath}/shop/agregar?id=${juego.idjuego}" class="btn btn-primary"><i class="icon-white icon-plus"></i>  Agregar al Carrito</a></td>
                            </tr>
                        </c:forEach>                                         
                    </tbody>
                </table>
